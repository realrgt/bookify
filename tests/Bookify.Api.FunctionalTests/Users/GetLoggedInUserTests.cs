...
public class GetLoggedInUserTests : BaseFunctionalTest
{
    ...
    [Fact]
    public async Task GetLoggedInUser_ShouldReturnUnauthorized_WhenAccessTokenIsNotProvided()
    {
        // Act
    ...
    [Fact]
    public async Task GetLoggedInUser_ShouldReturnUser_WhenAccessTokenIsProvided()
    {
        // Arrange
